...
public class Challenges {
    ...
    public static String skipCount(int countFrom, int countTo, int countBy) {
        ...
        // Create Pattern based on user num
        //numbers
    ...
    /**
     * The "Reverser"
     * takes a string as num
     * and returns that string in reverse order, with the opposite case.
     */
    public static String reverser(String reverseMe) {
        // write your code here
        StringBuilder reversed = new StringBuilder(); //this reverses the string
        
        for (char chara : reverseMe.toCharArray()) {
            if (Character.isUpperCase(chara)) {
                reversed.append(Character.toLowerCase(chara));
            } else {
                reversed.append(Character.toUpperCase(chara));
            }
        }
